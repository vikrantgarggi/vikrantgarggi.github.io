...
import { heroConfig } from "@/config/siteConfig";
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-primary-foreground leading-tight mb-6 animate-fade-in" style={{ animationDelay: "0.1s" }}>
              {heroConfig.headline}{" "}
              <span className="text-gradient">{heroConfig.headlineHighlight}</span>
            </h1>
            ...
            <div className="absolute -bottom-6 -left-6 bg-card rounded-xl p-4 shadow-elevated animate-float">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-accent-gradient rounded-lg flex items-center justify-center">
                  <span className="text-foreground font-bold text-lg">{heroConfig.floatingCard.value}</span>
                </div>
                <div>
                  <p className="text-foreground font-semibold">{heroConfig.floatingCard.label}</p>
                  <p className="text-muted-foreground text-sm">{heroConfig.floatingCard.sublabel}</p>
                </div>
              </div>
            </div>
          </div>
